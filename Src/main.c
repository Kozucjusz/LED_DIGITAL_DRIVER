...
int main(void) {
  ...
  while (1) {
    DS28E18_WRITE_SEQ((uint8_t[]){POT0_WRITE, RDAC1_WRITE_O1_HIGH, 0x01}, 3);
    HAL_Delay(3000);
    DS28E18_WRITE_SEQ((uint8_t[]){POT0_WRITE, RDAC1_WRITE_O1_LOW, 0x00}, 3);
    HAL_Delay(100);

    DS28E18_WRITE_SEQ((uint8_t[]){POT0_WRITE, RDAC2_WRITE_O1_HIGH, 0x01}, 3);
    HAL_Delay(3000);
    DS28E18_WRITE_SEQ((uint8_t[]){POT0_WRITE, RDAC2_WRITE_O1_LOW, 0x00}, 3);
    HAL_Delay(100);

    DS28E18_WRITE_SEQ((uint8_t[]){POT3_WRITE, RDAC1_WRITE_O1_HIGH, 0x01}, 3);
    HAL_Delay(3000);
    DS28E18_WRITE_SEQ((uint8_t[]){POT3_WRITE, RDAC1_WRITE_O1_LOW, 0x00}, 3);
    HAL_Delay(100);

    DS28E18_WRITE_SEQ((uint8_t[]){POT3_WRITE, RDAC2_WRITE_O1_HIGH, 0x01}, 3);
    HAL_Delay(3000);
    DS28E18_WRITE_SEQ((uint8_t[]){POT3_WRITE, RDAC2_WRITE_O1_LOW, 0x00}, 3);
    HAL_Delay(100);
  }
